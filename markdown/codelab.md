...
We will use a tag from HTML called div to define the structural blocks out app will consist of such as "Details" and "Workout".
...
- "p" acts similar to div, defining a component but is usually used as a paragraph (text)
...
- "button" creates the clicable button
